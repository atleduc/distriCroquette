...
#define speed -1000
#define stepPerRound 10178 // nombre de pas pour 1/2 tour
#define angleMini -2262 // angle d'une portion de tour
...
void GetDateStuff(uint16_t& Year, byte& Month, byte& Day, byte& DoW, byte& Hour, byte& Minute, byte& Second) { /* function GetDateStuff */
  ...
  // the order YYYYMMDDwHHMMSS, with an 'x' at the end. Ex. 20250806w130950x
